...
```
```{r}
1097.225/493.96325 #t-value
```
##The t-value calculated above is higher than the critical t-value which further suggests that the results are statistically significant.
