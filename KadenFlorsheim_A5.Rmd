...
#The areas that have the highest annual mean concentration of PM2.5 between 2015 and 2017 are Napa County, Oakland, and San Jose. 
...
#Now the mean of the residual is closer to zero. There are however two peaks in the data, which means that the data is still skewed. 